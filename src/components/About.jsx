    ...
    return (
        <section id="about">
            <div id="introduction" className="about-inner">
                ...
                <p>저는 초등학교 때 프로그래밍을 통해 간단한 게임을 만드는 경험을 하면서</p>
                ...
                <p>깊이 있는 지식을 쌓아 나갔고, 실제 프로젝트를 경험하며 실력을 향상시켰습니다.</p>
                ...
                <div className="profile-inner">
                    ...
                    <div className="profile-list">
                        <ul>
                            ...
                            <li><GoMortarBoard/><span>우송대학교 - IT융합학과 컴퓨터정보보안</span></li>
                        ...
                        <ul>
                            <li>
                                <a href="https://github.com/Pive0528"><GoMarkGithub/><span>Git</span></a>
                            </li>
                            <li><a href="https://velog.io/@pive0528"><SiBloglovin/><span>BLOG</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
